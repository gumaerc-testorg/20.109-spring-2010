...
{{< tdclose >}}
{{< tdopen >}}
{{% resource_link "d560db84-9f2b-4970-9dd5-2b7415c707dc" "DNA Ladder" %}}
{{< tdclose >}}
{{< tdopen >}}
14
{{< tdclose >}}
...
2.  In the following analysis, you will need the information for the {{% resource_link "d560db84-9f2b-4970-9dd5-2b7415c707dc" "1 Kbp DNA ladder" %}} you used.
...
1.  The pRSET plasmid with inverse pericam insert, or pRSET-IPC, is 4169 basepairs long. According to the cutters list ({{% resource_link 1109c22d-7068-0ba9-3809-2c4f613504ef "PDF" %}}) that you used on Day 1, restriction site _PvuI_ occurs at ~1685 bp, and again at ~2730 bp into pRSET-IPC. Thus, digesting this parental plasmid with the _PvuI_ enzyme should result in two linear fragments of DNA, with about 1050 and 3120 bp sizes.
    ...
    (A) Use NEB's {{% resource_link "8a935ac2-84b5-4bf0-9efa-b64f71ec1394" "NEBuffer Activity Chart for Restriction Enzymes" %}} to determine the appropriate buffer and temperature for your reactions.
