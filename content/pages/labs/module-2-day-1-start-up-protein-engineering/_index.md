...
Physical methods used to interrogate 3D protein structure include X-ray diffraction (XRD), electron microscopy, and nuclear magnetic resonance (NMR) spectroscopy. The paper by {{% resource_link "97ba7e9e-038f-4dd7-a33d-fdea84169a7f" "Zhang, et al. (1995)" %}} that you will refer to today describes the decoding of calmodulin's structure using NMR, which depends on subjecting molecules to electromagnetic fields and analyzing the resulting energy absorption spectra of their nuclei. Scientists who elucidate protein structures, in addition to publishing their results, will often add them to public databases such as the {{% resource_link "77366c3d-6f29-41ad-9939-88194b9c5b54" "Protein Data Bank" %}} (PDB). Because many proteins have structural motifs in common (e.g., alpha helices and beta sheets at the secondary level, or leucine-rich repeats at the tertiary level), which ultimately arise from their amino acid sequences, such databases can be useful for making predictions about proteins with known amino acid sequences but unknown structures. Today we will use a computer program that harnesses information in the Protein Data Bank to display interactive 3D models.
...
Chin, D., and A. R. Means. "{{% resource_link "75bb32f2-11be-46a6-abd9-03b9e596ef1d" "Calmodulin: A Prototypical Calcium Sensor" %}}." _Trends Cell Biol_ 10, no. 8 (August 2000): 322-328.

Zhang, M., et al. "{{% resource_link "a736cd4c-371f-4c8a-9163-08307a5f8a4c" "Calcium-Induced Conformational Transition Revealed by the Solution Structure of Apo Calmodulin" %}}." _Nat Struct Biol_ 2, no. 9 (September 1995): 758-67.
...
Green, D. F., et al. "{{% resource_link "a7d29fb7-05d0-48a5-a841-93dfad856bd0" "Rational Design of New Binding Specificity by Simultaneous Mutagenesis of Calmodulin and a Target Peptide" %}}." _Biochemistry_ 45, no. 41 (October 17, 2006): 12547-12559. \[Full text in PubMed Central\]
...
1.  {{% resource_link "34c9daaa-d43f-44ae-9dc0-585476146b7c" "Protein Explorer" %}} is a free web-based viewer for biological molecules. To access it, open the site in your browser. Choose "FirstGlance in Jmol" to proceed.
2.  Structures are organized according to PDB (Protein Data Bank) identification codes, which may be input at the prompt at the top of the page. Begin by looking at the molecule with {{% resource_link "77366c3d-6f29-41ad-9939-88194b9c5b54" "PDB" %}} ID number 1CLL, which is a calcium-bound form of calmodulin. Later you will search for an example of the ligand-free form, also called apo calmodulin.
...
**As you work, create a step-by-step record of your primer design in a Word document.** The logic for the major steps of your selection process should be clear. For example, once you have chosen your mutation site, you might begin by writing out the codon of interest. Next consider the options for coding a new amino acid, using this {{% resource_link "99943534-729e-40ce-8420-f65f50f53b7e" "Genetic Code table" %}} from New England Biolabs (NEB). Finally, you might pick the codon that incurs the fewest point mutations. **An example is outlined below****.**
...
Now we must keep 15-20 bp of sequence on each side in a way that meets all our requirements. To quickly find G/C content and see secondary structures, look at IDT's {{% resource_link "a80dbf83-f641-4498-96fa-feaf1aa6c0a3" "OligoAnalyzer" %}} Web site. (Note that the Tm listed at this site is not one that is relevant for mutagenesis.)
...
2.  Print out the results page for your mutation (and for S101L ({{% resource_link fce7f13b-c2a8-16e0-c781-fd434735b5a5 "PDF" %}}) if you want to practice (S101L file courtesy of Michael Palmer, used with permission). You should also use the New England Biolabs {{% resource_link "bd0b2c34-0e00-4d8d-b6a4-077e167023e5" "NEBcutter" %}} tool to produce a list of  restriction sites that occur 1-2 times in the inverse pericam plasmid, and those that cut 0 times.
