...
Kane, J. F. "{{% resource_link "cf73a4e2-d209-4851-9de2-99f530ca0087" "Effects of Rare Codon Clusters on High-Level Expression of Heterologous Proteins in *Escherichia coli*" %}}." *Curr Opin Biotechnol* 6, no. 5 (October, 1995): 494-500.

McNulty, D. E., et al. "{{% resource_link "6be50e90-7622-4d6a-894e-7c160601d52a" "Mistranslational Errors Associated With the Rare Arginine Codon CGG in *Escherichia coli*" %}}." *Protein Expr Purif*. 27, no. 2 (Febraury, 2003): 365-74.
...
4
{{< tdclose >}}{{< tdopen >}}
{{% resource_link "48679378-0892-4525-8fc4-ee3d676d4ac5" "1 Kb marker" %}}
{{< tdclose >}}{{< tdopen >}}
 
{{< tdclose >}}{{< trclose >}}{{< tropen >}}{{< tdopen >}}
5
...
8
{{< tdclose >}}{{< tdopen >}}
{{% resource_link "1204ca54-2a77-4d2e-8215-2308a3b1e41f" "100 bp marker" %}}
{{< tdclose >}}{{< tdopen >}}
...
Your goal today is to analyze the sequencing data for three samples - two independent colonies from your X#Z mutant, and one M124S clone for practice - and then decide which colony to proceed with for the X#Z mutant. You will want to have this Day 4 sequence document handy ({{% resource_link "0157b734-c176-9588-be86-0c21c8a74db7" "DOC" %}}), and to mark the expected location of your mutation with bold text before proceeding. (Just compare to your annotation of the Day 1 IPC sequence document ({{% resource_link "7acf0d4e-bb71-72a3-8be4-3d2826417320" "DOC" %}}) using Word Count or the Find tool.) The new file contains the inverse pericam sequence as before, but also the flanking sequences (from the pRSET vector) before and after IPC, which are separated from IPC by a blank line. The second page of the document contains the reverse complement of IPC/pRSET, which was generated using this website tool "{{% resource_link "77dc4886-da86-4595-977a-52f669c95084" "Reverse and/or complement DNA sequences." %}}" Be sure to bold your mutant codon in the reverse complement sequence as well.

Next we will use some data from the {{% resource_link "d6dbdcd9-7d5c-41de-bfa1-6e9862b6b6b1" "MIT Biopolymers Facility" %}}. \[\_Only available to enrolled students in the class, not accessible for OCW users.\_\] From this link, we can see sequencing traces and sequence text.
...
**Align with "bl2seq" from** {{% resource_link "00dd1f0d-5694-4c02-a53e-44f8507d776f" "**NCBI**" %}}

1. The alignment program can be accessed through the {{% resource_link "995c4447-b1ea-4863-83ac-860759c881e7" "NCBI BLAST" %}} page or directly from this {{% resource_link "d145ae1a-07a2-44ce-8ed5-69dcb0b59c38" "link" %}}.
...
For your reference, another popular sequence alignment program is "{{% resource_link "3d4c0a13-e989-45bb-9131-4c15f5f770ec" "CLUSTAL-W" %}}" from {{% resource_link "96ece491-215b-4173-a9bf-2798c7c0a592" "EMBL-EBI." %}}
