...
A quick but unscientific survey of several journal's "instructions for authors" shows some common themes that are worth considering here. For instance, the instructions from {{% resource_link "230dd9dd-6901-4f0e-8581-f3c36e27488c" "The Journal of Cell Biology" %}} (JCB) say:
...
Similarly, the instructions from {{% resource_link "3eda09cf-a120-4166-b40a-2f5b16cb8407" "Molecular Cell Biology" %}} (MCB) state:
